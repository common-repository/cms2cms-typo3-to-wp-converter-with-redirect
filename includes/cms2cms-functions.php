...
class CmsPluginFunctionsTYPO3
{
    ...
    private $jsConfig = '{
        ...
        "wp_feedback" : "//wordpress.org/support/plugin/cms2cms-typo3-to-wp-converter-with-redirect/reviews",
    ...
    {
        $cms2cms_typo3_access_login = get_option('cms2cms-typo3-login');
        $cms2cms_typo3_access_key   = get_option('cms2cms-typo3-key');

        return array(
            'email'     => $cms2cms_typo3_access_login,
            'accessKey' => $cms2cms_typo3_access_key
        );
    }
    ...
    public function isActivated()
    {
        ...
        return ($cms2cms_typo3_access_key != false);
    }
    ...
    public function getOptions()
    {
        ...
        $login = get_option('cms2cms-typo3-login');
    ...
    public function saveOptions()
    {
        ...
        if ( $key && $login ) {
            ...
            add_option('cms2cms-typo3-key', $key);

            delete_option('cms2cms-typo3-login');
            add_option('cms2cms-typo3-login', $login);

            delete_option('cms2cms-typo3-depth');
            add_option('cms2cms-typo3-depth', $bridge_depth);
    ...
    {
        return $this->__('Typo3', 'cms2cms-typo3-migration');
    }
    ...
    {
        return $this->__('WordPress', 'cms2cms-typo3-migration');
    }
    ...
    {
        return sprintf(
            $this->__('CMS2CMS: Automated %s to %s Migration ', 'cms2cms-typo3-migration'),
    ...
    {
        return sprintf(
            $this->__('%s to %s', 'cms2cms-typo3-migration'),
            $this->getPluginSourceName(),
            $this->getPluginTargetName()
        );
    }
